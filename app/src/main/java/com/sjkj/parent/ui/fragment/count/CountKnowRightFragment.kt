...
import com.sjkj.parent.ui.controller.count.CountKnowRightController
 ...
 * @desc CountKnowRightFragment
 */
class CountKnowRightFragment : BackBaseFragment() {
    ...
    private lateinit var mCountSubjectHandController: CountKnowRightController

    private fun initContainer() {
        mCountSubjectHandController = CountKnowRightController(context)
