...
import com.sjkj.parent.ui.controller.count.CountSubjectHandController
 ...
 */
class CountSubjectHandFragment : BackBaseFragment() {
    ...
    private lateinit var mCountSubjectHandController: CountSubjectHandController

    private fun initContainer() {
        mCountSubjectHandController = CountSubjectHandController(context)
    ...
    private fun initTopBar() {
        ...
        mTopBar?.setTitle(getString(R.string.count_subject_hand))
    }
}
