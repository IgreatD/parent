 ...
 */
class AssignDetailNormalController(context: Context) : BaseRecycleVController<QuestionBean, ClassRoomDetailViewHolder>(context), AssignContract.DetailBaseView, AssignContract.AssignHwView {
    ...
    private var mLibrarysIds: String = ""

    private var mCourseInfoID: Int = 0

    override fun onLoadMoreRequested() {
        assignDetailPresenter?.getNormalMoreData(mLibrarysIds, mCourseInfoID)
    }
    ...
    override fun onClickLoadData() {
        assignDetailPresenter?.getNormalData(mLibrarysIds, mCourseInfoID)
    }
    ...
    fun loadData(libraryIds: String?, courseInfoID: Int) {
        mLibrarysIds = libraryIds ?: ""
