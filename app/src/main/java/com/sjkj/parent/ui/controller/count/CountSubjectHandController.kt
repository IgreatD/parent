 ...
 */
class CountSubjectHandController(context: Context) : BaseController(context), CountContract.View {
    ...
    private fun initView() {
        ...
        mTimeView?.setOnTimeCheckListener(object : TimeView.OnTimeCheckListener {
            override fun confrim(startDate: String, endDate: String) {
                mCountSubjectHandPresenter?.getSubjectHandData(startDate, endDate)
            }
    ...
    fun loadData() {
        ...
        mCountSubjectHandPresenter?.getSubjectHandData(getMonthStartDate(), getMonthToday())
    }
