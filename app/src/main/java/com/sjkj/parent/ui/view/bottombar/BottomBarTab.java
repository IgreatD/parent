package com.sjkj.parent.ui.view.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.qmui_config_color_75_pure_black));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.qmui_config_color_50_pure_black));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.qmui_config_color_75_pure_black));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.qmui_config_color_75_pure_black));
        }
    }
