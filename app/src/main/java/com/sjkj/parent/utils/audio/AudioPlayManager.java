...
public class AudioPlayManager implements SensorEventListener {
            ...
            if (this._mediaPlayer.isPlaying()) {
                if ((double) range > 0.0D) {
                    ...
                    try {
                        ...
                        this._mediaPlayer.setDataSource(this._playingUri);
                        this._mediaPlayer.setOnPreparedListener(mp -> mp.seekTo(positions));
                        this._mediaPlayer.setOnSeekCompleteListener(MediaPlayer::start);
    ...
    private void replay() {
        try {
            ...
            this._mediaPlayer.setVolume(1.0F, 1.0F);
            this._mediaPlayer.setDataSource(this._playingUri);
            this._mediaPlayer.setOnPreparedListener(MediaPlayer::start);
            this._mediaPlayer.prepareAsync();
    ...
    public void startPlay(Context context, String audioUri, IAudioPlayListener playListener) {
        if (context != null && audioUri != null) {
            ...
            try {
                ...
                this._mediaPlayer.setDataSource(audioUri);
